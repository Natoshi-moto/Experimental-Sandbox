...
- Verified against: `gh api repos/Natoshi-moto/Lab/branches/main/protection`, `gh api repos/Natoshi-moto/Experimental-Sandbox/branches/main/protection`, `gh api repos/Natoshi-moto/Experimental-Sandbox` (`security_and_analysis`), `./nexus doctor` on `/home/anon/Lab`.

## For later / next

- Fix the CMA-authorization gap in `run-public-experiment/SKILL.md` / `risk-bands.md`.
